...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
    ...
    protected final ImageView mHeaderImage = null;
    protected final ProgressBar mHeaderProgress = null;
    ...
    private int mInterpolatorWidth;
...
*/
    ...
    public final int getContentSize() {
        switch (mScrollDirection) {
            case HORIZONTAL:
                if (mInterpolatorWidth == 0) mInterpolatorWidth = mInnerLayout.getWidth();
                return mInterpolatorWidth;
            case VERTICAL:
            default:
